...
with open('C:/Users/zakar/Desktop/single rl code/Q-learning-gridworld/q_learning/walls.pickle', 'rb') as f:
    walls = pickle.load(f)
with open('C:/Users/zakar/Desktop/single rl code/Q-learning-gridworld/q_learning/specials.pickle', 'rb') as f:
    specials = pickle.load(f)

def try_move(dx, dy):
    global player, x, y, score, walk_reward, me, restart ,goal1_x,goal1_y
    #if restart == True:
     #   restart_game()
    new_x = player[0] + dx
    new_y = player[1] + dy
